...
public class PromoDao {
    ...
    public List<Map> getPromoRateMpfByAllSinceDate(Date sinceDate) {
          ...
          String _sql = " select d.*, nvl(R.DEALER_ID,'ALL')DEALER_ID, r.buss_unit, nvl(R.OBJT_CODE, 'ALL')OBJT_CODE, nvl(R.OBJT_GRP,'ALL')OBJT_GRP,r.RATE_PROMO,nvl(r.BRANCH_ID,'ALL')BRANCH_ID from ordmgmt.om_mst_setup_rate r,"
                + "(SELECT   d.promo_mst_code, m.promo_mst_desc, d.promo_dtl_id,         "
                + "d.promo_dtl_desc, d.coy_id, nvl(d.promo_dtl_branch,'ALL')promo_dtl_branch,            d.promo_dtl_valid_date startdate , d.promo_dtl_invalid_date endDate  "
